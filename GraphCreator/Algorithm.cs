namespace GraphCreator
{
    ...
    public class Algorithm
    {
        ...
        private static readonly List<Algorithm> algorithms = new()
        {
            ...
            new Algorithm("Quick_Sort", "GraphCreator", "SortAlgorithms", "QuickSortAlg", "Line", 10000000),
            new Algorithm("Tim_Sort", "GraphCreator", "SortAlgorithms", "TimSortAlg", "Line", 10000000),
            new Algorithm("Comb_Sort", "GraphCreator", "SortAlgorithms", "CombSortAlg", "Line", 10000000),
